...
FIND_LIBRARY(FFTW_LIBRARY_F_OMP NAMES fftw3f_omp PATHS /usr/lib /usr/local/lib /opt/locala/lib ${FFTW_DIR})
FIND_LIBRARY(FFTW_LIBRARY_D_OMP NAMES fftw3_omp  PATHS /usr/lib /usr/local/lib /opt/locala/lib ${FFTW_DIR})
FIND_LIBRARY(FFTW_LIBRARY_L_OMP NAMES fftw3l_omp PATHS /usr/lib /usr/local/lib /opt/locala/lib ${FFTW_DIR})
...
IF (FFTW_LIBRARY_D AND FFTW_LIBRARY_D_OMP AND FFTW_INCLUDE_DIR)
    SET(FFTW_LIBRARIES ${FFTW_LIBRARY_F} ${FFTW_LIBRARY_D} ${FFTW_LIBRARY_L} ${FFTW_LIBRARY_F_OMP} ${FFTW_LIBRARY_D_OMP} ${FFTW_LIBRARY_L_OMP})
    IF(WIN32)
      SET(FFTW_RUNTIME_LIBRARIES ${FFTW_RUNTIME_LIBRARY_F} ${FFTW_RUNTIME_LIBRARY_D} ${FFTW_RUNTIME_LIBRARY_L})
    ENDIF(WIN32)
    SET(FFTW_FOUND true)
ELSE (FFTW_LIBRARY_D AND FFTW_LIBRARY_D_OMP AND FFTW_INCLUDE_DIR)
    SET(FFTW_FOUND false)
    SET(FFTW_LIBRARIES "")
ENDIF (FFTW_LIBRARY_D AND FFTW_LIBRARY_D_OMP AND FFTW_INCLUDE_DIR)
