...
IF (MKL_LINKTOOL)
    EXECUTE_PROCESS(COMMAND ${MKL_LINKTOOL} ${MKL_LINKTOOL_OPTS} -check_mkl_presence -libs
    ...
    EXECUTE_PROCESS(COMMAND ${MKL_LINKTOOL} ${MKL_LINKTOOL_OPTS} -check_mkl_presence -opts
    ...
    EXECUTE_PROCESS(COMMAND ${MKL_LINKTOOL} ${MKL_LINKTOOL_OPTS} -check_mkl_presence -env
        OUTPUT_STRIP_TRAILING_WHITESPACE
